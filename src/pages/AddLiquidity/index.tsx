  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA ? currencyIdA : 'PKF'}/${newCurrencyIdB}`);
      }
    },
            ...
            {noLiquidity ||
              (isCreate ? (
                <ColumnCenter>
                  <LightCard>
                    <AutoColumn gap="10px">
                      <TYPE.black fontWeight={600} color={'black'}>
                        You are the first liquidity provider.
                      </TYPE.black>
                      <TYPE.black fontWeight={400} color={'black'}>
              ...
              <>
                <LightCard padding="0px" borderRadius={'20px'}>
                  <RowBetween padding="1rem">
                    <TYPE.darkGray fontWeight={500} fontSize={14}>
